...
import io.agora.rtc.mediaio.app.videoSource.ui.PrivateTextureViewActivity;
import media.ushow.utils.FilePathUtil;

public class VideoRecorderActivity extends PrivateTextureViewActivity implements OnClickListener {
...
//        mZoomSeekBar.setOnSeekBarChangeListener(seekBarCallBack);
        container = (FrameLayout) findViewById(R.id.texture_view_container);
        super.initAgoraView();
    }
